...
$sql2 = "SELECT * FROM landing_pages WHERE id = " . $page_id;
...
<body class=" font-sans">
    ...
    <div class="py-12 sm:py-24">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl text-center">
                ...
                <p class="mt-6 font-light text-2xl leading-8 text-gray-600">
                    <?php echo '' . $desc; ?>
                </p>
            </div>
        </div>
    ...
    <section class="py-16">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl mb-8 text-gray-900 font-light text-center">Our Product</h2>
    ...
    <footer class="bg-gray-900 text-white py-8">
        <div class="container mx-auto px-4 text-center">
            <p>&copy; <?php echo date("Y"); ?> <?php echo '' . $b_name; ?>. All rights reserved.</p>
        </div>
    </footer>
