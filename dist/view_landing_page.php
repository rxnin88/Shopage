...
if (!$page_id) {
    // Redirect to pages page if no page ID is provided
    header("Location: landingPages.php");
    exit();
}

// Retrieve the template information from the database
$sql = "SELECT * FROM landing_pages WHERE id = '$page_id'";
...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto py-20 px-6">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <a href="" class="ms-1 text-sm font-medium text-black md:ms-2 "><?php echo htmlspecialchars($landing_page['name']); ?></a>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="container mx-auto py-10">
            ...
            <div class="bg-white outline outline-1 outline-gray-400 rounded-lg p-6 mb-8">
                <h1 class="text-5xl my-6"><?php echo htmlspecialchars($landing_page['name']); ?></h1>
                <p class="text-gray-700 mb-4">Description : <?php echo htmlspecialchars($landing_page['shop_desc']); ?></p>
                <p class="text-gray-700 mb-4">Business Name : <?php echo htmlspecialchars($landing_page['business_name']); ?></p>
